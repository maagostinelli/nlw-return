    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center py-8 w-[304px]">
                ...
                <span className="mt-2 text-xl"> Agrademos o feedback!</span>
                <button 
                type="button"
                className="mt-6 py-2 px-6 bg-zinc-800 rounded-md border-transparent hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-darkSurfacePrimary-500 focus:ring-brand-500"
